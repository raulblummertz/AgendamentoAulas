...
public class AulaService : IServiceBase<AulaDto>
{
    private readonly IRepositoryBase<Aula> _aulaRepository;

    public AulaService(IRepositoryBase<Aula> aulaRepository)
    {
        _aulaRepository = aulaRepository;
    }

    public async Task Cadastrar(AulaDto aulaDto)
    {
    ...
    public async Task<IEnumerable<AulaDto>> ListarTodos()
    {
    ...
    public async Task<AulaDto?> ListarPorId(int id)
    {
